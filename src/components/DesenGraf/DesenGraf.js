    ...
    return (
        <div style={{position: "absolute", top:"30px", left:"200px"}}>
            <Popover placement="start-right">
                ...
                <PopoverContent>
                    <Card style={{ backgroundColor: "#f9f9f9", borderRadius: "8px", padding: "2px", boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)", marginLeft: "140px"}}>
                        <CardBody>
